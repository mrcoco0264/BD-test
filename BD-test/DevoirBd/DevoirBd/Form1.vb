...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim StrConnection As String = "Driver={Microsoft ODBC for Oracle};
Server=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=132.209.11.3)(PORT=1521))(CONNECT_DATA=(SID=coursbd)));
Uid=SMI1002_16;Pwd=76wbwa63;"
